					...
					<div class="container_12">
						...
						<div class="grid_12">
							...
							<nav class="horizontal-nav full-width horizontalNav-notprocessed">
								...
								<ul class="sf-menu">
                                <!-- <li><a href="<?=base_url();?>index.php/welcome/logout"><i class="glyphicon glyphicon-eye-open"></i> View As</a></li>
                                    <li><a href="<?=base_url();?>index.php/Controller_Admin"><i class="glyphicon glyphicon-cog"></i> Settings</a></li> -->
									<li><a href="<?=base_url();?>index.php/welcome"><i class="fa fa-sign-out fa-fw"></i> Login</a></li>
