	        ...
	        <div class="col-md-4 col-md-offset-4">
	            <div class="login-panel panel panel-default">
	                <div class="panel-heading">
	                    <h3 class="panel-title" align="center">Ud tours - Please Sign In</h3>
	                </div>
	                <div class="panel-body">
	                    ...
	                    <form role="form" method="post" onsubmit="return checkEmptyInput();" action="<?=base_url()?>welcome/login/">
	                        <fieldset>
	                            ...
	                            <input id="login-submit" type="submit" value="Login" class="btn lg btn-warning btn-block"><br>
								<div class="form-group" align="center">
								<center><strong>Or</strong></center>
	                                <a href="<?php echo base_url()?>index.php/welcome/register" class="btn btn-primary">Register Now</a>
	                            </div>
	                        </fieldset>
	                    </form>
	                </div>
